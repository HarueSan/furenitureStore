        ...
        <div class="container" style="margin-left: 0; margin-top: 40px">
            <div class="row">
                ...
                <div class="row">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" placeholder="20/10/2020" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                        </div>
                    </div>
                    <div class="row" style="margin-top: 20px">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" placeholder="โต๊ะพับ" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                        </div>
                    </div>
                    <div class="row" style="margin-top: 20px">
                        <div class="col-2">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <input type="number" class="form-control" placeholder="150" aria-label="Baht price">
                    ...
                    <div class="row" style="margin-top: 20px">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                <input type="number" class="form-control" placeholder="18" aria-label="Baht price">
                                <div class="input-group-append">
                    ...
                    <div class="row" style="margin-top: 20px">
                        ...
                        <div class="col-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="ขาว" aria-label="Baht price">
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 20px">
