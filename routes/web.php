...
Route::get('/returndelivery',[DeliveryController::class,'returnDelivery']);

Route::post('deletedelivery',[DeliveryController::class,'deleteDelivery']);//คืนสินค้ากลับไป และระบุจำนวน
